...
const ExternalProviderAuditForm = () => {
    ...
    useEffect(() => {
        ...
        const completedItems = formData.checklists.reduce(
            (acc, cl) => acc + cl.items.filter(item => item.selectedValue).length, 
            0
        );
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
                                {isViewMode ? 'View Audit' : isEditMode ? 'Edit Audit' : 'New Audit'}
                            </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-xl">
                        <div className="text-3xl font-bold text-gray-800">
                            {formData.totalItems > 0 ? Math.round((formData.completedItems / formData.totalItems) * 100) : 0}%
                        </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="form-input w-full pr-10 bg-gray-50"
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm mt-1">
                                        Complete the audit checklist with Yes/No/N/A options
                                    </p>
                                </div>
                            </div>
                                                                ...
                                                                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                                                                    ...
                                                                    <div className="lg:col-span-2 space-y-4">
                                                                        <div>
                                                                            ...
                                                                            {/* Radio Options with styled buttons */}
                                                                                ...
                                                                                {item.options.map(option => (
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        <span className="flex items-center">
                                                                                            {option.value === 'yes' && <IconCheck className="w-4 h-4 mr-2" />}
                                                                                            {option.value === 'no' && <IconX className="w-4 h-4 mr-2" />}
                                                                                            {option.value === 'na' && <IconMinus className="w-4 h-4 mr-2" />}
                                                                                            {option.label}
                                                                                        </span>
                                                                                    </label>
                                                                                ))}
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                placeholder="Add observations, comments, or findings..."
                                                                                disabled={isViewMode}
                                                                            />
                                                                        </div>
                                                                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                    <div className={`border-b border-gray-200 ${expandedSections.workerInterviews ? 'bg-gradient-to-r from-purple-50 to-white' : ''}`}>
                        ...
                        >
                            ...
                            <div className="flex items-center space-x-4">
                                <span className="hidden md:inline text-sm text-gray-500">
                                    {formData.workerInterviews.length} interviews
                                </span>
                                                ...
                                                <div className="flex flex-col md:flex-row md:items-start gap-4">
                                                    ...
                                                    {newInterview.questions.length > 1 && (
                                                        <button
                                                            ...
                                                            className="btn btn-outline-danger btn-sm self-start"
                                                        >
                                                            <IconTrash className="w-4 h-4" />
                                                        </button>
                                                    )}
                ...
                <div className="sticky bottom-0 bg-white border-t border-gray-200 p-4 md:p-6 -mx-4 md:-mx-6 mt-8 shadow-lg">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="text-sm text-gray-600">
                            ...
                            Progress: <span className="font-semibold">{formData.completedItems}/{formData.totalItems}</span> items
                        </div>
